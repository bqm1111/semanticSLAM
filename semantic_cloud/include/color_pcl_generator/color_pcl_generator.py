...
class ColorPclGenerator:
    ...
    def generate_cloud_semantic_max(
        self, bgr_img, depth_img, semantic_color, confidence, stamp
    ):
        self.generate_cloud_data_common(bgr_img, depth_img)
    ...
    def generate_cloud_semantic_bayesian(
        self, bgr_img, depth_img, semantic_colors, confidences, stamp
    ):
        """
        ...
        # Concatenate data
        self.ros_data[:, 8 : 8 + self.num_semantic_colors] = (
